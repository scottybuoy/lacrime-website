  ...
  return (
    <div id='home-cont'>
      <div id='mission-stmnt-cont'>
        <img alt='whole co logo' src={`${process.env.PUBLIC_URL}/images/whole-w-slogan.png`} id='home-intro-logo'></img>
      ...
      <div id='home-product-cont'>
        <img alt='lacrime serum bottles' src={`${process.env.PUBLIC_URL}/images/serum-both.png`} id='home-product-both'></img>
        <div id='home-product-logo-cont'>
          <img alt='lacrime logo' src={`${process.env.PUBLIC_URL}/images/lacrime-logo.png`} id='home-product-logo'></img>
